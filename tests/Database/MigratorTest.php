...
final class MigratorTest extends TestCase
{
    ...
    public function testMigrationsRunOnceAndCreateCoreTables(): void
    {
        ...
        self::assertSame(['001_create_core_tables.php', '002_create_catalog_tables.php'], $firstRun);
        self::assertSame([], $secondRun);
        self::assertSame(['001_create_core_tables.php', '002_create_catalog_tables.php'], $status['executed']);
        self::assertSame([], $status['pending']);

        foreach (['schema_migrations', 'users', 'audit_logs', 'app_settings', 'products', 'product_variants'] as $table) {
